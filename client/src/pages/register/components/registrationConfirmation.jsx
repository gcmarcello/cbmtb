...
const ConfirmRegistration = ({ name }) => {
  return (
    <div className="container inner-page">
      <h1>
        {" "}
        <i className="bi bi-check-circle-fill text-success"></i> Bem vindo(a) à {config.entidade.name}!
      </h1>
      <p>
        {name || "Usuário"}, obrigado por se cadastrar no sistema da {config.entidade.name}! Para concluir seu cadastro, você precisa confirmar sua
        conta. Por favor, siga as instruções abaixo para confirmar sua conta:
      </p>
      <ul>
