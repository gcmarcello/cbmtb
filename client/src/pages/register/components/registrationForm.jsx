    ...
    <div className="container inner-page px-3">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="needs-validation" noValidate>
        ...
        <div className="row mb-2">
          ...
          <div className="col-12 col-lg-6">
            <label htmlFor="name">
              Confirmar CPF<span className="text-danger">*</span>
            </label>
            <Controller
              name="repeatCpf"
              control={control}
              ...
              rules={{
                required: true,
                validate: (value) => value === getValues("cpf"),
              }}
              render={({ field }) => (
                <InputMask
                  mask="999.999.999-99"
        ...
        <div className="row">
          <div className="col-12 col-lg-6">
            ...
            <div className="row">
              ...
              <div className="col-12 col-lg-6">
                <label htmlFor="birthDate">
                  Confirmar Data de Nascimento<span className="text-danger">*</span>
                </label>
                <input
                  id="repeatBirthDate"
                  type="date"
                  ...
                  {...register("repeatBirthDate", {
                    required: true,
                    pattern: /^\d{4}-\d{2}-\d{2}$/i,
                    validate: (value) => value === getValues("birthDate"),
                  })}
                  aria-invalid={errors.birthDate ? "true" : "false"}
                />
              </div>
