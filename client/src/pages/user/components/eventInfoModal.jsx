            ...
            <div className="modal-body">
              ...
              <ul className="list-group mb-3">
                <li className="list-group-item">
                  <i className="bi bi-person-fill"></i> <span className="fw-bolder">Nome:</span> {userInfo.user_first_name} {userInfo.user_last_name}
                </li>
                <li className="list-group-item">
              ...
              <div className="mb-3">
                ...
                <p>Por favor, tenha-o disponível no seu celular ou em uma cópia impressa para facilitar o processo de check-in no dia do evento.</p>
              </div>
              <div className="d-flex justify-content-center" style={{ background: "white", padding: "16px" }}>
