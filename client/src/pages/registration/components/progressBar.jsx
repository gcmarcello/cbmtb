      ...
      <div className="row justify-content-center align-items-center">
            ...
            <div className="position-relative">
              ...
              <div className="position-absolute start-100 translate-middle ">
                <button
                  ...
                  disabled={props.watch("rulesAgreement") && props.watch("registrationShirt") && props.watch("category") ? false : true}
                >
                  3
                </button>
        ...
        <div className="col-2 px-0 d-flex justify-content-center">
          <button
            ...
            disabled={
              props.stage === 2
                ? props.watch("rulesAgreement") && props.watch("registrationShirt") && props.watch("category")
                  ? false
                  : true
                : props.stage === 3
                ? true
