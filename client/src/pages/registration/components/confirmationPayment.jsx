          ...
          <div className="col-12 col-lg-6">
              ...
              <li className="list-group-item d-flex justify-content-between align-items-center ">
                <div className="py-2">
                  ...
                  <small className="text-muted">
                    {
                      props.event?.categories.filter(
                        (category) =>
                          category.category_id === props.watch("category")
                      )[0]?.category_name
                    }{" "}
            ...
            <div className="mt-2">
              <p className="text-justify">
                ...
                seu perfil. Você receberá a confirmação da inscrição por e-mail
                e ela também estará disponível no seu perfil.
              </p>
            </div>
